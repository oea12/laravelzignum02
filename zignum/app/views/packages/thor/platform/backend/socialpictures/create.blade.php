...
<div class="row">
  <div class="col-lg-12">
    <h1 class="page-header">@if($module)<i class="module-icon fa {{$module->icon}}"></i>@endif  Create Social Picture</h1>
    ...
    {{ Form::open(array('method' => 'POST', 'route' => array('backend.socialpictures.do_create'), 'role'=>'form','file' => true, 'enctype' => 'multipart/form-data')) }}
